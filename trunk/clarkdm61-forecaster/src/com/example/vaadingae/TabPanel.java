...
public class TabPanel extends CustomComponent {
	...
	protected void initEventList(List<FinancialEvent> list) {
		...
		managerTable.addContainerProperty("Financial Event", String.class, null);
		for (FinancialEvent fe : list) {
			managerTable.addItem(new Object[]{fe.getLabelString()});
			System.out.println("Added: " + fe.getLabelString());
		}
