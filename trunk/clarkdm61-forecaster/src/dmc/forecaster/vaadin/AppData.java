 ...
 * The basis for the datastructure, use of ThreadLocal, and initialization comes
 * directly from the Book of Vaadin.
 * 
 * @author David
 * 
 */
public class AppData implements TransactionListener, Serializable {
	...
	public static void setFinancialEventList(
			List<FinancialEvent> financialEventList) {
